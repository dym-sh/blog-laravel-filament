...
<body class="bg-gray-50 font-family-karla">
    ...
    <nav class="w-full py-4 border-t border-b bg-gray-100" x-data="{ open: false }">
        ...
        <div :class="open ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div class="w-full container mx-auto flex flex-row items-center justify-between text-sm font-bold uppercase mt-0 px-6 py-2">
                <div>
                ...
                <div class="flex items-center ms-6">
                    @auth
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="hover:bg-blue-600 hover:text-white rounded py-2 px-4 mx-2 flex flex-nowrap items-center">
